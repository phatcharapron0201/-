...
const OfficialRankModal: React.FC<OfficialRankModalProps> = ({ newRank, playerName, onClose }) => {
  return (
      ...
      >
        <div className="w-full h-full flex flex-col items-center justify-center text-center">
            ...
            <p className="text-base font-medium leading-relaxed font-serif-sc">
                奉天承运<br/>
                皇帝诏曰<br/>
                คุณหนู <span className="text-lg font-bold text-red-800">{playerName}</span><br/>
                มีคุณสมบัติเพียบพร้อมและเป็นที่โปรดปราน<br/>
                บัดนี้朕จึงมีพระบรมราชโองการ<br/>
                แต่งตั้งให้เข้ารับตำแหน่งอย่างเป็นทางการ<br/>
            </p>
...
export default OfficialRankModal;